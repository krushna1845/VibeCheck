...
/**
 * Hardened Security configuration for movie-service.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/movies/**", "/api/v1/genres/**", "/api/v1/languages/**").permitAll()

                // Admin catalog mutations require ROLE_ADMIN or ROLE_INTERNAL_SERVICE
                .requestMatchers(HttpMethod.POST, "/api/v1/movies/**", "/api/v1/genres/**", "/api/v1/languages/**")
                    .hasAnyRole("ADMIN", "INTERNAL_SERVICE")
                .requestMatchers(HttpMethod.PUT, "/api/v1/movies/**", "/api/v1/genres/**", "/api/v1/languages/**")
                    .hasAnyRole("ADMIN", "INTERNAL_SERVICE")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/movies/**", "/api/v1/genres/**", "/api/v1/languages/**")
                    .hasAnyRole("ADMIN", "INTERNAL_SERVICE")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/movies/**", "/api/v1/genres/**", "/api/v1/languages/**")
                    .hasAnyRole("ADMIN", "INTERNAL_SERVICE")
