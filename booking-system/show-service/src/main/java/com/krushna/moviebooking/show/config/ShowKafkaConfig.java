...
public class ShowKafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, Object> showConsumerFactory(ObjectMapper objectMapper) {
    ...
    @Bean
    public ProducerFactory<String, Object> showProducerFactory(ObjectMapper objectMapper) {
